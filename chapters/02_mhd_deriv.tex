...
\begin{itemize}
    ...
    \]
    \item Average kinetic energy density $\vec{w}_s(\vec{r},t)$:
    \[
    g(\vec{v})=\frac{1}{2}m_s\vec{v}^2 \implies \vec{w}_s(\vec{r},t) =\frac{1}{n_s(\vec{r}, t)} \int d\vec{v} \, \frac{1}{2}m_s\vec{v}^2 f_s(\vec{r},\vec{v},t) \, .
    \]
\end{itemize}
