...
Because $\int d\vec{v} \, \vec{v} f_s = \int d\vec{v} \, \vec{u}_s f_s = n_s \vec{u}_s$ we notice that $\overleftrightarrow{P}_s^{cm}$ is equal to
        \begin{align*}
            \overleftrightarrow{P}_s^{cm} &= \int d\vec{v} \,m_s\, (\vec{v}-\vec{V}) \otimes (\vec{v}-\vec{V}) f_s(\vec{r},\vec{v},t)\\
            &= \int d\vec{v} \,m_s\, (\vec{v}- \vec{u}_s + \vec{u}_s -\vec{V}) \otimes (\vec{v}-\vec{u}_s + \vec{u}_s - \vec{V}) f_s(\vec{r},\vec{v},t)\\
            &= \int d\vec{v} \,m_s\, (\vec{v}- \vec{u}_s) \otimes (\vec{v}-\vec{u}_s) f_s(\vec{r},\vec{v},t)
              + \int d\vec{v} \,m_s\, (\vec{v}- \vec{u}_s) \otimes (\vec{u}_s - \vec{V}) f_s(\vec{r},\vec{v},t)\\
            & + \int d\vec{v} \,m_s\, (\vec{u}_s -\vec{V}) \otimes (\vec{v}-\vec{u}_s) f_s(\vec{r},\vec{v},t)
              + \int d\vec{v} \,m_s\, (\vec{u}_s -\vec{V}) \otimes (\vec{u}_s - \vec{V}) f_s(\vec{r},\vec{v},t)\\
            &= \overleftrightarrow{P}_s + m_s (\vec{u}_s -\vec{V}) \otimes (\vec{u}_s - \vec{V}) n_s
        \end{align*}
