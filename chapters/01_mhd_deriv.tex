...
In the following we specifically apply  \cite{Freidberg2014}, section 2.2.3.
...
\item Isotropic pressure and incompressible motion
    ...
    \textbf{Adiabatic closure:} Using the adiabatic equation of state and mass conservation, we obtain
    \[
